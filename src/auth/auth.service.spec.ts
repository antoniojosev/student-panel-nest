...
describe('AuthService', () => {
  ...
  describe('register', () => {
    ...
    it('should register as instructor and return token', async () => {
      ...
      prisma.user.create.mockResolvedValue({ id: '1', email: dto.email, name: dto.name, role: 'instructor' as const });
  ...
  describe('login', () => {
    ...
    it('should return user and token on valid credentials', async () => {
      prisma.user.findUnique.mockResolvedValue({
        id: '1', email: dto.email, name: 'Test', role: 'instructor' as const, password: hashedPassword,
      });
