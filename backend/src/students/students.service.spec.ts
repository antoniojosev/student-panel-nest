...
describe('StudentsService', () => {
  ...
  const instructor1 = { id: 'inst-1', role: 'instructor' };
  const instructor2 = { id: 'inst-2', role: 'instructor' };
  ...
  describe('create', () => {
    ...
    it('should allow admin to assign student to a specific instructor', async () => {
      prisma.user.findUnique.mockResolvedValue({ id: 'inst-1', role: 'instructor' });
      prisma.student.create.mockResolvedValue({ ...dto, id: 'stu-2', instructorId: 'inst-1' });
